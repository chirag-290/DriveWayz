...
const RideHistory = () => {
  ...
  useEffect(() => {
    const fetchRideHistory = async () => {
      try {
        const res = await axios.get(`${import.meta.env.VITE_BASE_URL}/rides/user/${userId}`);
    ...
    <div className="min-h-screen bg-gray-100">
      <div className="container mx-auto py-8 px-4">
        <div className="flex justify-between items-center mb-6">
          ...
          <Link to="/home" className="px-4 py-2 bg-gray-800 text-white rounded-lg hover:bg-gray-700">
            Back to Home
          </Link>
        </div>
        ...
        {rides.length === 0 ? (
          <div className="bg-white rounded-lg shadow-md p-8 text-center">
            ...
            <p className="mt-2 text-gray-500">You haven't taken any rides yet.</p>
          </div>
        ) : (
                ...
                <div className="p-5">
                  ...
                  <div className="flex justify-between items-center pt-4 border-t border-gray-200">
                    <div>
                      ...
                      <p className="font-medium">{ride.captain?.fullname.firstname || "Not assigned"}</p>
                    </div>
